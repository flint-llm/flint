...
_labels= {'model_runtime': '{{ DATASPINE_MODEL_RUNTIME}}',
          'model_type': '{{ DATASPINE_MODEL_TYPE }}',
          'model_name': '{{ DATASPINE_MODEL_NAME }}',
          'model_tag': '{{ DATASPINE_MODEL_TAG }}',
          'model_chip': '{{ DATASPINE_MODEL_CHIP }}',
         }
